...
describe('TestResultPreparing', () => {
  describe('prepareUnitTestResult', () => {
    test('should prepare unit test results from TRX files and attachment files', async () => {
      ...
      (AttachmentFilesBase64.addAttachmentFilesAsync as jest.Mock).mockResolvedValueOnce(mockedUnitTestResults);
      ...
      expect(AttachmentFilesBase64.addAttachmentFilesAsync).toHaveBeenCalledWith(
